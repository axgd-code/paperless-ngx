...
class ProviderRegistry:
    ...
    @classmethod
    def register(cls, provider_type: str, provider_class: type[BaseIntegrationProvider]):
        """
    ...
    @classmethod
    def get_provider(cls, provider_type: str) -> Optional[type[BaseIntegrationProvider]]:
        """
    ...
    def create_provider(
        ...
        provider_type: str, 
        integration: Any
    ) -> Optional[BaseIntegrationProvider]:
        """
